<script lang="ts">
	...
	let title = $derived(
		statusCode === 410
			? (isNorwegian ? 'Arrangementet er over' : 'This event has ended')
			: statusCode === 404
	...
	let message = $derived(
		statusCode === 410
			? (isNorwegian
				? 'Dette arrangementet er avsluttet. Her er noen kommende arrangementer:'
				: 'This event has ended. Here are some upcoming events:')
