...
const collections: Collection[] = [
	{
		...
		quickAnswer: {
			no: 'Gåri samler helgens arrangementer i Bergen fra 45 lokale kilder — konserter, utstillinger, familieaktiviteter og mer. Oppdatert daglig fra steder som Grieghallen, KODE, USF Verftet og Akvariet.',
			en: 'Gåri collects this weekend\'s events in Bergen from 45 local sources — concerts, exhibitions, family activities and more. Updated daily from venues like Grieghallen, KODE, USF Verftet and Akvariet.'
		},
		editorial: {
			no: [
				...
				'Gåri samler helgeprogrammet fra over 45 lokale arrangørkilder — teatre, museer, spillesteder, festivalarrangører og billettplattformer — og oppdaterer listen daglig. Enten du planlegger lørdag kveld eller søker en rolig søndagsopplevelse, er alt samlet her.',
			...
			en: [
				...
				'Gåri collects the weekend programme from over 45 local event sources — theatres, museums, venues, festival organisers and ticketing platforms — and updates the listing daily. Whether you are planning Saturday evening or looking for a relaxed Sunday experience, everything is here in one place.',
		...
		faq: {
			no: [
				{ q: 'Hva skjer i Bergen denne helgen?', a: 'Gåri viser alle helgens arrangementer i Bergen — konserter, utstillinger, familieaktiviteter og mer. Oppdatert daglig fra 45 lokale kilder.' },
			...
			en: [
				{ q: "What's on in Bergen this weekend?", a: 'Gåri shows all weekend events in Bergen — concerts, exhibitions, family activities and more. Updated daily from 45 local sources.' },
	...
	},
	{
		...
		quickAnswer: {
			no: 'Se alle arrangementer i Bergen i kveld — konserter, teater, uteliv og mer. Gåri henter data fra 45 lokale kilder og oppdateres to ganger daglig.',
			en: 'See all events in Bergen tonight — concerts, theatre, nightlife and more. Gåri pulls data from 45 local sources and updates twice daily.'
		},
		editorial: {
			no: [
			...
			en: [
				...
				'Gåri updates twice daily — morning and evening — so the evening picture is always fresh. Listings are pulled directly from 45 Bergen event sources, from Grieghallen to Brettspillkafeen, and include start times for all events.',
	...
	},
	{
		...
		quickAnswer: {
			no: 'Gratis ting å gjøre i Bergen denne uken — utstillinger, bibliotekaktiviteter, turer og mer. Gåri samler kostnadsfrie arrangementer fra 45 lokale kilder.',
			en: 'Free things to do in Bergen this week — exhibitions, library events, hikes and more. Gåri collects free events from 45 local sources.'
		},
		editorial: {
			no: [
				...
				'Gåri samler alle gratis arrangementer i Bergen fra 45 lokale kilder og oppdaterer listen daglig. Her ser du gratis konserter, utstillinger, turer og aktiviteter — alt denne uken, uten billettpris.',
			...
			en: [
				...
				'Gåri collects all free events in Bergen from 45 local sources and updates the listing daily. Here you find free concerts, exhibitions, hikes and activities — all this week, no ticket required.',
	...
	},
	{
		...
		quickAnswer: {
			no: 'Hva skjer i Bergen i dag? Gåri viser alle dagens arrangementer — konserter, utstillinger, mat og mer — samlet fra 45 lokale kilder.',
			en: 'What\'s on in Bergen today? Gåri shows all of today\'s events — concerts, exhibitions, food and more — collected from 45 local sources.'
		},
		editorial: {
			no: [
				...
				'Gåri samler arrangementer fra 45 lokale Bergen-kilder — spillesteder, festivalarrangører og billettplattformer — og oppdaterer listen to ganger daglig. Alt fra Grieghallen og Bergen Bibliotek til Fløyen og Akvariet er dekket.',
			...
			en: [
				...
				'Gåri aggregates events from 45 local Bergen sources — venues, festival organisers and ticketing platforms — and updates listings twice daily so what you see is always current.',
	...
	},
	{
		...
		quickAnswer: {
			no: 'Familievennlige arrangementer i Bergen denne helgen — barneforestillinger, museumsaktiviteter, dyrepark og utendørsopplevelser. Samlet fra 45 lokale kilder.',
			en: 'Family-friendly events in Bergen this weekend — children\'s shows, museum activities, aquarium visits and outdoor experiences. Collected from 45 local sources.'
		},
		editorial: {
			no: [
				...
				'Gåri-siden for familiehelg viser helgens barneforestillinger, museumsaktiviteter og familievennlige arrangementer i Bergen fra 45 lokale kilder. Listen oppdateres daglig og viser hva som faktisk skjer denne helgen.',
			...
			en: [
				...
				'Gåri\'s family weekend page shows this weekend\'s children\'s shows, museum activities and family-friendly events in Bergen from 45 local sources. The listing is updated daily to show what is actually happening this weekend.',
	...
	},
	{
		...
		quickAnswer: {
			no: 'Alle konserter og livemusikk i Bergen denne uken — fra Grieghallen og Ole Bull til Hulen og Kvarteret. Gåri samler konsertprogrammet fra 45 lokale kilder.',
			en: 'All concerts and live music in Bergen this week — from Grieghallen and Ole Bull to Hulen and Kvarteret. Gåri collects the concert schedule from 45 local sources.'
		},
		editorial: {
			no: [
				...
				'Gåri samler alle konserter og livemusikk-arrangementer i Bergen denne uken fra 45 lokale kilder — billettsider, festivalsider og direkte fra spillestedene. Listen oppdateres daglig, og Gåri fjerner automatisk konserter som er utsolgt.',
			...
			en: [
				...
				'Gåri collects all concerts and live music events in Bergen this week from 45 local sources — ticketing sites, festival pages and directly from the venues. The listing is updated daily and Gåri automatically removes sold-out concerts.',
		...
		faq: {
			no: [
				{ q: 'Hvilke konserter er det i Bergen denne uken?', a: 'Gåri samler alle konserter og livemusikk-arrangementer i Bergen denne uken fra 45 lokale kilder. Oppdatert daglig.' },
			...
			en: [
				{ q: 'What concerts are on in Bergen this week?', a: 'Gåri collects all concerts and live music events in Bergen this week from 45 local sources. Updated daily.' },
	...
	},
	{
		...
		quickAnswer: {
			no: 'Alle arrangementer i Bergen denne helgen — konserter, utstillinger, familieaktiviteter og mer. Oppdatert daglig fra 45 lokale kilder.',
			en: 'All events in Bergen this weekend — concerts, exhibitions, family activities and more. Updated daily from 45 local sources.'
		},
		editorial: {
			no: [
				...
				'Gåri samler Bergens helgearrangementer fra 45 lokale kilder — spillesteder, festivalarrangører og billettplattformer — og oppdaterer listen daglig. Grieghallen, USF Verftet, Ole Bull, DNS, Forum Scene, KODE, Bergen Kunsthall og byens mange mindre scener og gallerier er alle dekket.',
			...
			en: [
				...
				'Gåri collects Bergen weekend events from 45 local sources — venues, festival organisers and ticketing platforms — and updates listings daily. Grieghallen, USF Verftet, Ole Bull, DNS, Forum Scene, KODE, Bergen Kunsthall and the city\'s many smaller stages and galleries are all covered.',
		...
		faq: {
			no: [
				{ q: 'Hva skjer i Bergen denne helgen?', a: 'Gåri viser alle helgens arrangementer i Bergen — konserter, utstillinger, mat og mer. Oppdatert daglig fra 45 lokale kilder.' },
			...
			en: [
				{ q: "What's on in Bergen this weekend?", a: 'Gåri shows all weekend events in Bergen — concerts, exhibitions, food and outdoor activities. Updated daily from 45 local sources.' },
	...
	},
	{
		...
		quickAnswer: {
			no: 'Alle arrangementer i Bergen i dag — konserter, utstillinger, turer og mer. Gåri samler dagens program fra 45 lokale kilder, oppdatert to ganger daglig.',
			en: 'All events in Bergen today — concerts, exhibitions, tours and more. Gåri collects today\'s schedule from 45 local sources, updated twice daily.'
		},
		editorial: {
			no: [
				...
				'Gåri henter alle arrangementer som skjer i Bergen i dag fra 45 lokale kilder og oppdaterer to ganger daglig — morgen og kveld. Du ser alltid et ferskt bilde av dagsprogrammet, med tidspunkt for alle arrangementer inkludert.',
			...
			en: [
				...
				'Gåri pulls all events happening in Bergen today from 45 local sources and updates twice daily — morning and evening. You always see a fresh picture of the day\'s programme, with start times included for all events.',
		...
		faq: {
			no: [
				{ q: 'Hva skjer i Bergen i dag?', a: 'Gåri viser alle arrangementer i Bergen i dag — konserter, utstillinger, teater, familieaktiviteter og mer. Oppdatert morgen og kveld fra 45 lokale kilder.' },
			...
			en: [
				{ q: "What's happening in Bergen today?", a: 'Gåri shows all events in Bergen today — concerts, exhibitions, theatre, family activities and more. Updated twice daily from 45 local sources.' },
	...
	},
	{
		...
		quickAnswer: {
			no: 'Gratis ting å gjøre i Bergen de neste to ukene — utstillinger, konserter, turer og aktiviteter uten billettpris. Samlet fra 45 lokale kilder.',
			en: 'Free things to do in Bergen over the next two weeks — exhibitions, concerts, hikes and activities with no ticket price. Collected from 45 local sources.'
		},
		editorial: {
			no: [
				...
				'Gåri viser alle gratis arrangementer i Bergen de neste to ukene, fra 45 lokale kilder og oppdatert daglig. Fra sentrum til Nordnes og Fana er gratis aktiviteter spredt over hele byen. To ukers vindu gir deg god tid til å planlegge rundt gratis museumsdager, bibliotekarrangementer og uteaktiviteter.',
			...
			en: [
				...
				'Gåri lists all free events in Bergen over the next two weeks, drawn from 45 local sources and updated daily. From the city centre to Nordnes and Fana, free activities are spread across the whole city. The two-week window gives visitors time to plan around free museum days, library events and outdoor activities.',
		...
		faq: {
			no: [
				{ q: 'Hva er gratis å gjøre i Bergen?', a: 'Gåri viser alle gratis arrangementer i Bergen de neste to ukene — utstillinger, konserter, turer og aktiviteter. Oppdatert daglig fra 45 lokale kilder.' },
				...
				{ q: 'Hva kan turister gjøre gratis i Bergen?', a: 'Bergen Kunsthall, biblioteknettverk og Fløyen-turer er jevnlig gratis. Gåri samler alle gratis arrangementer fra 45 lokale Bergen-kilder.' }
			],
			en: [
				{ q: 'What free things are there to do in Bergen?', a: 'Gåri lists all free events in Bergen over the next two weeks — exhibitions, concerts, hikes and activities. Updated daily from 45 sources.' },
				...
				{ q: 'What can I do for free in Bergen as a tourist?', a: 'Bergen Kunsthall, the public library network and Fløyen hikes are regularly free. Gåri collects all free events from 45 local Bergen sources.' }
			]
		},
		filterEvents: (events, now) => {
			const todayStr = toOsloDateStr(now);
	...
	},
	{
		...
		quickAnswer: {
			no: 'Regner det i Bergen? Her er innendørsarrangementer de neste to ukene — konserter, teater, utstillinger og familieaktiviteter. Samlet fra 45 lokale kilder.',
			en: 'Raining in Bergen? Here are indoor events over the next two weeks — concerts, theatre, exhibitions and family activities. Collected from 45 local sources.'
		},
		editorial: {
			no: [
				...
				'Gåri-siden for regnværsdager viser innendørsarrangementer i Bergen de neste to ukene — konserter, teater, utstillinger, verksteder, matopplevelser og familieaktiviteter. Siden oppdateres daglig og henter data fra 45 lokale kilder.',
			...
			en: [
				...
				'Gåri\'s rainy day guide shows indoor events in Bergen over the next two weeks — concerts, theatre, exhibitions, workshops, food experiences and family activities. The listing updates daily from 45 local sources.',
	...
	},
	{
		...
		quickAnswer: {
			no: 'Arrangementer i Bergen sentrum de neste to ukene — konserter, teater, utstillinger og mat i gangavstand fra Bryggen. Samlet fra 45 lokale kilder.',
			en: 'Events in Bergen city centre over the next two weeks — concerts, theatre, exhibitions and dining within walking distance of Bryggen. Collected from 45 local sources.'
		},
		editorial: {
			no: [
				...
				'Gåri viser alle arrangementer i Bergen sentrum de neste to ukene — spillesteder, teatre, gallerier, bibliotek, matarrangementer og kulturhus. Listen hentes fra 45 lokale kilder og oppdateres daglig.',
			...
			en: [
				...
				'Gåri shows all events in Bergen city centre over the next two weeks — venues, theatres, galleries, libraries, food events and cultural centres. Listings are drawn from 45 local sources and updated daily.',
		...
		faq: {
			no: [
				{ q: 'Hva skjer i Bergen sentrum?', a: 'Gåri viser alle arrangementer i Bergen sentrum de neste to ukene — konserter, utstillinger, teater og mer fra 45 lokale kilder.' },
			...
			en: [
				{ q: "What's on in Bergen city centre?", a: 'Gåri shows all events in Bergen city centre over the next two weeks — concerts, exhibitions, theatre and more from 45 local sources.' },
	...
	},
	{
		...
		quickAnswer: {
			no: 'Kulturopplevelser for voksne i Bergen de neste to ukene — konserter, teater, omvisninger, utstillinger og matarrangementer. Samlet fra 45 lokale kilder.',
			en: 'Cultural experiences for adults in Bergen over the next two weeks — concerts, theatre, guided tours, exhibitions and food events. Collected from 45 local sources.'
		},
		editorial: {
			no: [
				...
				'Gåri samler arrangementer innen musikk, kultur, teater, omvisninger, mat og verksteder — alt tilpasset voksne. Listen hentes fra over 45 lokale kilder og oppdateres daglig. Utsolgte arrangementer fjernes fortløpende.',
			...
			en: [
				...
				'Gåri collects events in music, culture, theatre, guided tours, food and workshops — all suited to adults. Listings are drawn from over 45 local sources and updated daily. Sold-out events are removed as soon as they sell out.',
	...
	},
	{
		...
		quickAnswer: {
			no: 'Arrangementer for ungdom (13–18 år) i Bergen de neste to ukene — konserter, kultur, sport og workshops. Uten uteliv og 18+-arrangementer. Fra 45 lokale kilder.',
			en: 'Events for teens (13–18) in Bergen over the next two weeks — concerts, culture, sports and workshops. No nightlife or 18+ events. From 45 local sources.'
		},
		editorial: {
			no: [
				...
				'Gåri samler arrangementer fra over 45 lokale kilder og oppdaterer listen daglig. Vi filtrerer bort arrangementer med aldersgrense (18+/20+) og uteliv, slik at det som vises passer for aldersgruppen 13\u201318 år.',
			...
			en: [
				...
				'Gåri collects events from over 45 local sources and updates the listing daily. We filter out events with age restrictions (18+/20+) and nightlife, so everything shown is suitable for the 13\u201318 age group.',
