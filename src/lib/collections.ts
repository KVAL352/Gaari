...
const collections: Collection[] = [
	{
		...
		relatedSlugs: ['gratis', 'familiehelg', 'konserter', 'i-kveld', 'teater'],
		...
		quickAnswer: {
			no: `Bergen har typisk 40 til 80 arrangementer hver helg — konserter på Grieghallen og Ole Bull, utstillinger på KODE og Kunsthallen, familieaktiviteter på Akvariet og Fløyen, teater på DNS og forestillinger på USF Verftet. Samlet fra ${SOURCE_COUNT} lokale kilder, oppdatert daglig.`,
			en: `Bergen typically has 40 to 80 events each weekend — concerts at Grieghallen and Ole Bull, exhibitions at KODE and Kunsthallen, family activities at the Aquarium and Fløyen, theatre at DNS and performances at USF Verftet. Collected from ${SOURCE_COUNT} local sources, updated daily.`
		},
		editorial: {
			no: [
				...
				`Gåri samler helgeprogrammet fra over ${SOURCE_COUNT} lokale arrangørkilder — teatre, museer, spillesteder, festivalarrangører og billettplattformer — og oppdaterer listen daglig. Enten du planlegger lørdag kveld eller søker en rolig søndagsopplevelse, er alt samlet her.`,
			...
			en: [
				...
				`Gåri collects the weekend programme from over ${SOURCE_COUNT} local event sources — theatres, museums, venues, festival organisers and ticketing platforms — and updates the listing daily. Whether you are planning Saturday evening or looking for a relaxed Sunday experience, everything is here in one place.`,
		...
		faq: {
			no: [
				{ q: 'Hva skjer i Bergen denne helgen?', a: `Gåri viser alle helgens arrangementer i Bergen — konserter, utstillinger, familieaktiviteter og mer. Oppdatert daglig fra ${SOURCE_COUNT} lokale kilder.` },
				...
				{ q: 'Hvor mange arrangementer har Bergen i helgene?', a: `Bergen har typisk 40–80 arrangementer hver helg — fra konserter på Grieghallen til utstillinger på KODE og familieaktiviteter på Akvariet. Gåri samler dem fra ${SOURCE_COUNT} kilder.` },
				...
				{ q: 'Hva er Bergens beste helgeopplevelse?', a: `Bergen tilbyr noe for enhver smak — klassisk konsert på Grieghallen, besøk på KODE, teater på DNS eller en kveld på Bryggen. Gåri samler alle helgearrangementer fra ${SOURCE_COUNT} lokale kilder slik at du enkelt kan planlegge.` },
			...
			en: [
				{ q: "What's on in Bergen this weekend?", a: `Gåri shows all weekend events in Bergen — concerts, exhibitions, family activities and more. Updated daily from ${SOURCE_COUNT} local sources.` },
				...
				{ q: 'How many events does Bergen have on weekends?', a: `Bergen typically has 40–80 events each weekend — from concerts at Grieghallen to exhibitions at KODE and family activities at Akvariet. Gåri collects them from ${SOURCE_COUNT} sources.` },
				...
				{ q: "What is Bergen's best weekend experience?", a: `Bergen has something for every taste — a classical concert at Grieghallen, a visit to KODE, theatre at DNS or an evening on Bryggen. Gåri collects all weekend events from ${SOURCE_COUNT} local sources so you can plan easily.` },
	...
	},
	{
		...
		description: {
			no: `Hva skjer i Bergen i kveld? Konserter, teater, uteliv og kveldsarrangementer — oppdatert daglig fra ${SOURCE_COUNT} lokale kilder.`,
			en: `What's on in Bergen tonight? Concerts, theatre, nightlife and evening events — updated daily from ${SOURCE_COUNT} local sources.`
		},
		ogSubtitle: {
		...
		quickAnswer: {
			...
			en: `Bergen has cultural events on weekday evenings, not just weekends. Concerts at Ole Bull and Forum Scene, theatre at DNS and Cornerteateret, nightlife at Hulen and Madam Felle. Collected from ${SOURCE_COUNT} local sources.`
		},
		editorial: {
			no: [
				'Bergen har kulturliv på hverdagskvelder, ikke bare i helgene. Musikk­scener som Ole Bull, Forum Scene, USF Verftet og Kulturhuset setter opp show og konserter gjennom hele uken. Teatrene DNS, Bergen Internasjonale Teater (BIT), Det Vestnorske Teatret og Cornerteateret spiller forestillinger mandag til fredag. Kvarteret og studentmiljøet er aktive fra torsdag og utover.',
				`Gåri oppdateres daglig slik at kveldsbildet alltid er ferskt. Listen henter data direkte fra ${SOURCE_COUNT} bergenske arrangørers nettsider, fra Grieghallen til Brettspillkafeen, og inkluderer tidspunkt for alle arrangementer.`,
			...
			en: [
				...
				`Gåri updates daily — morning and evening — so the evening picture is always fresh. Listings are pulled directly from ${SOURCE_COUNT} Bergen event sources, from Grieghallen to Brettspillkafeen, and include start times for all events.`,
	...
	},
	{
		...
		slug: 'gratis',
		title: {
			no: 'Gratis ting å gjøre i Bergen',
			en: 'Free Things to Do in Bergen'
		},
		description: {
			no: 'Gratis ting å gjøre i Bergen de neste to ukene — utstillinger, konserter, turer og mer. Ingen billett nødvendig.',
			en: 'Free things to do in Bergen over the next two weeks — exhibitions, concerts, tours and more. No ticket needed.'
		},
		ogSubtitle: {
			no: 'Gratis arrangementer de neste to ukene',
			en: 'Free events over the next two weeks'
		},
		relatedSlugs: ['denne-helgen', 'familiehelg', 'regndagsguide', 'utstillinger'],
		...
		quickAnswer: {
			no: `Bergen har et rikt gratis kulturtilbud — utstillinger på Bergen Kunsthall, arrangementer på Bergen Bibliotek, fjellturer med DNT og parkkonserter om sommeren. Samlet fra ${SOURCE_COUNT} lokale kilder.`,
			en: `Bergen has a generous free cultural offering — exhibitions at Bergen Kunsthall, events at Bergen Library, mountain hikes with DNT and park concerts in summer. Collected from ${SOURCE_COUNT} local sources.`
		},
		editorial: {
			no: [
				...
				`Gåri samler alle gratis arrangementer i Bergen fra ${SOURCE_COUNT} lokale kilder og oppdaterer listen daglig. Her ser du gratis konserter, utstillinger, turer og aktiviteter de neste to ukene, uten billettpris.`,
			...
			en: [
				...
				`Gåri collects all free events in Bergen from ${SOURCE_COUNT} local sources and updates the listing daily. Here you find free concerts, exhibitions, hikes and activities over the next two weeks, no ticket required.`,
		...
		faq: {
			no: [
				{ q: 'Hva er gratis å gjøre i Bergen?', a: 'Gåri viser alle gratis arrangementer i Bergen de neste to ukene — utstillinger, konserter, turer og aktiviteter uten billettpris.' },
	...
	},
	{
		...
		quickAnswer: {
			no: `Hva skjer i Bergen i dag? Gåri viser alle dagens arrangementer — konserter, utstillinger, mat og mer — samlet fra ${SOURCE_COUNT} lokale kilder.`,
			en: `What's on in Bergen today? Gåri shows all of today's events — concerts, exhibitions, food and more — collected from ${SOURCE_COUNT} local sources.`
		},
		editorial: {
			no: [
				...
				`Gåri samler arrangementer fra ${SOURCE_COUNT} lokale Bergen-kilder — spillesteder, festivalarrangører og billettplattformer — og oppdaterer listen daglig. Alt fra Grieghallen og Bergen Bibliotek til Fløyen og Akvariet er dekket.`,
			...
			en: [
				...
				`Gåri aggregates events from ${SOURCE_COUNT} local Bergen sources — venues, festival organisers and ticketing platforms — and updates listings daily so what you see is always current.`,
		...
		faq: {
			no: [
				...
				{ q: 'Når oppdateres Gåri?', a: `Gåri oppdateres daglig klokken 06:00. Arrangementdata hentes direkte fra ${SOURCE_COUNT} lokale kilder i Bergen.` },
			...
			en: [
				...
				{ q: 'How often is Gåri updated?', a: `Gåri updates daily at 06:00. Event data is pulled directly from ${SOURCE_COUNT} local sources in Bergen.` },
	...
	},
	{
		...
		quickAnswer: {
			no: `Familievennlige arrangementer i Bergen denne helgen — barneforestillinger, museumsaktiviteter, dyrepark og utendørsopplevelser. Samlet fra ${SOURCE_COUNT} lokale kilder.`,
			en: `Family-friendly events in Bergen this weekend — children's shows, museum activities, aquarium visits and outdoor experiences. Collected from ${SOURCE_COUNT} local sources.`
		},
		editorial: {
			no: [
				...
				`Gåri-siden for familiehelg viser helgens barneforestillinger, museumsaktiviteter og familievennlige arrangementer i Bergen fra ${SOURCE_COUNT} lokale kilder. Listen oppdateres daglig og viser hva som faktisk skjer denne helgen.`,
			...
			en: [
				...
				`Gåri's family weekend page shows this weekend's children's shows, museum activities and family-friendly events in Bergen from ${SOURCE_COUNT} local sources. The listing is updated daily to show what is actually happening this weekend.`,
	...
	},
	{
		...
		ogSubtitle: {
			...
			en: 'Live music over the next two weeks'
		},
		...
		quickAnswer: {
			no: `Bergen har over 20 konsertscener — Grieghallen for klassisk, Ole Bull og Forum Scene for pop og rock, USF Verftet for alternativt, Hulen og Kvarteret for studenter. Konsertprogrammet de neste to ukene, samlet fra ${SOURCE_COUNT} lokale kilder.`,
			en: `Bergen has over 20 concert venues — Grieghallen for classical, Ole Bull and Forum Scene for pop and rock, USF Verftet for alternative, Hulen and Kvarteret for students. Concert schedule for the next two weeks, collected from ${SOURCE_COUNT} local sources.`
		},
		editorial: {
			no: [
				...
				`Gåri samler alle konserter og livemusikk-arrangementer i Bergen de neste to ukene fra ${SOURCE_COUNT} lokale kilder — billettsider, festivalsider og direkte fra spillestedene. Listen oppdateres daglig, og Gåri fjerner automatisk konserter som er utsolgt.`,
			...
			en: [
				...
				`Gåri collects all concerts and live music events in Bergen over the next two weeks from ${SOURCE_COUNT} local sources — ticketing sites, festival pages and directly from the venues. The listing is updated daily and Gåri automatically removes sold-out concerts.`,
		...
		faq: {
			no: [
				{ q: 'Hvilke konserter er det i Bergen?', a: `Gåri samler alle konserter og livemusikk-arrangementer i Bergen de neste to ukene fra ${SOURCE_COUNT} lokale kilder. Oppdatert daglig.` },
			...
			en: [
				{ q: 'What concerts are on in Bergen?', a: `Gåri collects all concerts and live music events in Bergen over the next two weeks from ${SOURCE_COUNT} local sources. Updated daily.` },
				...
				{ q: 'Where can I find live music in Bergen?', a: 'Gåri collects all live music in Bergen from over 20 venues. Hulen, Kvarteret and Bergen Kjøtt have gigs several nights a week. Ole Bull and Forum Scene host bigger acts. Check this page for the full concert schedule.' }
			]
		},
		filterEvents: (events, now) => {
			const todayStr = toOsloDateStr(now);
	...
	},
	{
		...
		slug: 'studentkveld',
		title: {
			no: 'Studentkveld i Bergen denne uken',
			en: 'Student Nights in Bergen This Week'
		},
		description: {
			no: 'Studentguide Bergen: kveldsarrangementer for studenter denne uken — fester, quiz, konserter på Kvarteret, Hulen og mer.',
			en: 'Student guide to Bergen: evening events for students this week — parties, quizzes, concerts at Kvarteret, Hulen and more.'
		},
		ogSubtitle: {
			no: 'For studenter denne uken',
			en: "This week's student events"
		},
		...
		quickAnswer: {
			no: 'Studentarrangementer i Bergen denne uken — fester, quiz, konserter og kulturkvelder på Kvarteret, Hulen og andre studentsteder. Oppdatert daglig.',
			en: 'Student events in Bergen this week — parties, quizzes, concerts and cultural evenings at Kvarteret, Hulen and other student venues. Updated daily.'
		},
		editorial: {
			no: [
		...
		faq: {
			no: [
				{ q: 'Hva skjer for studenter i Bergen denne uken?', a: 'Gåri viser kveldsarrangementer for studenter i Bergen denne uken — fester, quiz, konserter, uteliv og mer. Oppdatert daglig.' },
				{ q: 'Hvor er det studentfester i Bergen?', a: 'Kvarteret er Norges største studentklubb i Bergen. Sjekk Gåri for alle studentarrangementer denne uken.' },
				...
				{ q: 'Er det quiz-kvelder for studenter i Bergen?', a: 'Kvarteret og flere puber i sentrum har jevnlige quiz-kvelder, ofte midt i uken. Sjekk Gåri for neste quiz med dato og sted.' }
			],
			en: [
				{ q: "What's on for students in Bergen this week?", a: "Gåri shows this week's student events in Bergen — parties, quizzes, concerts, nightlife and more. Updated daily." },
				{ q: 'Where are student parties in Bergen?', a: "Kvarteret is Norway's largest student venue in Bergen. Check Gåri for all student events this week." },
				...
				{ q: 'Are there pub quizzes for students in Bergen?', a: 'Kvarteret and several pubs in the centre host regular quiz nights, often midweek. Check Gåri for the next quiz with date and venue.' }
			]
		},
		filterEvents: (events, now) => {
			const todayStr = toOsloDateStr(now);
	...
	},
	{
		...
		newsletterHeading: { no: 'Få helgens arrangementer hver torsdag', en: 'Get weekend picks every Thursday' },
		quickAnswer: {
			no: `Alle arrangementer i Bergen denne helgen — konserter, utstillinger, familieaktiviteter og mer. Oppdatert daglig fra ${SOURCE_COUNT} lokale kilder.`,
			en: `All events in Bergen this weekend — concerts, exhibitions, family activities and more. Updated daily from ${SOURCE_COUNT} local sources.`
		},
		editorial: {
			no: [
				...
				`Gåri samler Bergens helgearrangementer fra ${SOURCE_COUNT} lokale kilder — spillesteder, festivalarrangører og billettplattformer — og oppdaterer listen daglig. Grieghallen, USF Verftet, Ole Bull, DNS, Forum Scene, KODE, Bergen Kunsthall og byens mange mindre scener og gallerier er alle dekket.`,
			...
			en: [
				...
				`Gåri collects Bergen weekend events from ${SOURCE_COUNT} local sources — venues, festival organisers and ticketing platforms — and updates listings daily. Grieghallen, USF Verftet, Ole Bull, DNS, Forum Scene, KODE, Bergen Kunsthall and the city's many smaller stages and galleries are all covered.`,
		...
		faq: {
			no: [
				{ q: 'Hva skjer i Bergen denne helgen?', a: `Gåri viser alle helgens arrangementer i Bergen — konserter, utstillinger, mat og mer. Oppdatert daglig fra ${SOURCE_COUNT} lokale kilder.` },
			...
			en: [
				{ q: "What's on in Bergen this weekend?", a: `Gåri shows all weekend events in Bergen — concerts, exhibitions, food and outdoor activities. Updated daily from ${SOURCE_COUNT} local sources.` },
				...
				{ q: 'What is there to do in Bergen on Sunday?', a: 'Bergen is just as active on Sunday as Saturday. Museums and galleries are open, libraries have events, and many venues run Sunday evening shows. Check Gåri for Sunday\'s full programme.' }
			]
		},
		filterEvents: (events, now) => {
			const { start, end } = getWeekendDates(now);
	...
	},
	{
		...
		quickAnswer: {
			...
			en: `All events in Bergen today — concerts, exhibitions, tours and more. Gåri collects today's schedule from ${SOURCE_COUNT} local sources, updated daily.`
		},
		editorial: {
			no: [
				...
				`Gåri henter alle arrangementer som skjer i Bergen i dag fra ${SOURCE_COUNT} lokale kilder og oppdaterer daglig. Du ser alltid et ferskt bilde av dagsprogrammet, med tidspunkt for alle arrangementer inkludert.`,
			...
			en: [
				...
				`Gåri pulls all events happening in Bergen today from ${SOURCE_COUNT} local sources and updates daily — morning and evening. You always see a fresh picture of the day's programme, with start times included for all events.`,
		...
		faq: {
			no: [
				{ q: 'Hva skjer i Bergen i dag?', a: `Gåri viser alle arrangementer i Bergen i dag — konserter, utstillinger, teater, familieaktiviteter og mer. Oppdatert daglig fra ${SOURCE_COUNT} lokale kilder.` },
				...
				{ q: 'Hvor mange arrangementer har Bergen daglig?', a: `Bergen har typisk 20–50 arrangementer daglig — konserter, utstillinger, teater og aktiviteter. Helger har flere enn hverdager. Gåri samler alle fra ${SOURCE_COUNT} kilder.` },
			...
			en: [
				{ q: "What's happening in Bergen today?", a: `Gåri shows all events in Bergen today — concerts, exhibitions, theatre, family activities and more. Updated daily from ${SOURCE_COUNT} local sources.` },
				...
				{ q: 'How many events does Bergen have daily?', a: `Bergen typically has 20–50 events daily — concerts, exhibitions, theatre and activities. Weekends have more than weekdays. Gåri collects them all from ${SOURCE_COUNT} sources.` },
	...
	},
	{
		...
		newsletterHeading: { no: 'Finn gratisopplevelser hver uke', en: 'Find free events every week' },
		quickAnswer: {
			no: `Gratis ting å gjøre i Bergen de neste to ukene — utstillinger, konserter, turer og aktiviteter uten billettpris. Samlet fra ${SOURCE_COUNT} lokale kilder.`,
			en: `Free things to do in Bergen over the next two weeks — exhibitions, concerts, hikes and activities with no ticket price. Collected from ${SOURCE_COUNT} local sources.`
		},
		editorial: {
			no: [
				...
				`Gåri viser alle gratis arrangementer i Bergen de neste to ukene, fra ${SOURCE_COUNT} lokale kilder og oppdatert daglig. Fra sentrum til Nordnes og Fana er gratis aktiviteter spredt over hele byen. To ukers vindu gir deg god tid til å planlegge rundt gratis museumsdager, bibliotekarrangementer og uteaktiviteter.`,
			...
			en: [
				...
				`Gåri lists all free events in Bergen over the next two weeks, drawn from ${SOURCE_COUNT} local sources and updated daily. From the city centre to Nordnes and Fana, free activities are spread across the whole city. The two-week window gives visitors time to plan around free museum days, library events and outdoor activities.`,
		...
		faq: {
			no: [
				{ q: 'Hva er gratis å gjøre i Bergen?', a: `Gåri viser alle gratis arrangementer i Bergen de neste to ukene — utstillinger, konserter, turer og aktiviteter. Oppdatert daglig fra ${SOURCE_COUNT} lokale kilder.` },
				...
				{ q: 'Hva kan turister gjøre gratis i Bergen?', a: `Bergen Kunsthall, biblioteknettverk og Fløyen-turer er jevnlig gratis. Gåri samler alle gratis arrangementer fra ${SOURCE_COUNT} lokale Bergen-kilder.` },
			...
			en: [
				{ q: 'What free things are there to do in Bergen?', a: `Gåri lists all free events in Bergen over the next two weeks — exhibitions, concerts, hikes and activities. Updated daily from ${SOURCE_COUNT} sources.` },
				...
				{ q: 'What can I do for free in Bergen as a tourist?', a: `Bergen Kunsthall, the public library network and Fløyen hikes are regularly free. Gåri collects all free events from ${SOURCE_COUNT} local Bergen sources.` },
	...
	},
	{
		...
		relatedSlugs: ['gratis', 'familiehelg', 'voksen', 'utstillinger', 'teater'],
		...
		quickAnswer: {
			no: `Regner det i Bergen? Her er innendørsarrangementer de neste to ukene — konserter, teater, utstillinger og familieaktiviteter. Samlet fra ${SOURCE_COUNT} lokale kilder.`,
			en: `Raining in Bergen? Here are indoor events over the next two weeks — concerts, theatre, exhibitions and family activities. Collected from ${SOURCE_COUNT} local sources.`
		},
		editorial: {
			no: [
				...
				`Gåri-siden for regnværsdager viser innendørsarrangementer i Bergen de neste to ukene — konserter, teater, utstillinger, verksteder, matopplevelser og familieaktiviteter. Siden oppdateres daglig og henter data fra ${SOURCE_COUNT} lokale kilder.`,
			...
			en: [
				...
				`Gåri's rainy day guide shows indoor events in Bergen over the next two weeks — concerts, theatre, exhibitions, workshops, food experiences and family activities. The listing updates daily from ${SOURCE_COUNT} local sources.`,
	...
	},
	{
		...
		description: {
			no: 'Arrangementer i Bergen sentrum de neste to ukene — Grieghallen, DNS, KODE, Bryggen og mer. Alt i gangavstand. Oppdatert daglig.',
			en: 'Events in Bergen city centre over the next two weeks — Grieghallen, DNS, KODE, Bryggen and more. All within walking distance. Updated daily.'
		},
		ogSubtitle: {
		...
		quickAnswer: {
			no: `Arrangementer i Bergen sentrum de neste to ukene — konserter, teater, utstillinger og mat i gangavstand fra Bryggen. Samlet fra ${SOURCE_COUNT} lokale kilder.`,
			en: `Events in Bergen city centre over the next two weeks — concerts, theatre, exhibitions and dining within walking distance of Bryggen. Collected from ${SOURCE_COUNT} local sources.`
		},
		editorial: {
			no: [
				...
				`Gåri viser alle arrangementer i Bergen sentrum de neste to ukene — spillesteder, teatre, gallerier, bibliotek, matarrangementer og kulturhus. Listen hentes fra ${SOURCE_COUNT} lokale kilder og oppdateres daglig.`,
			...
			en: [
				...
				`Gåri shows all events in Bergen city centre over the next two weeks — venues, theatres, galleries, libraries, food events and cultural centres. Listings are drawn from ${SOURCE_COUNT} local sources and updated daily.`,
		...
		faq: {
			no: [
				{ q: 'Hva skjer i Bergen sentrum?', a: `Gåri viser alle arrangementer i Bergen sentrum de neste to ukene — konserter, utstillinger, teater og mer fra ${SOURCE_COUNT} lokale kilder.` },
			...
			en: [
				{ q: "What's on in Bergen city centre?", a: `Gåri shows all events in Bergen city centre over the next two weeks — concerts, exhibitions, theatre and more from ${SOURCE_COUNT} local sources.` },
				...
				{ q: 'What are the best cultural experiences in Bergen city centre?', a: "Bergen city centre has Grieghallen (concerts), Bergen Kunsthall (contemporary art), KODE (Norway's largest art museum), Den Nationale Scene (theatre) and Litteraturhuset (talks) — all within walking distance of each other." }
			]
		},
		filterEvents: (events, now) => {
			const todayStr = toOsloDateStr(now);
	...
	},
	{
		...
		quickAnswer: {
			no: `Arrangementer på Bergenhus de neste to ukene — konserter på USF Verftet, utstillinger på Bryggens Museum, familieaktiviteter på Akvariet og mer. Fra ${SOURCE_COUNT} lokale kilder.`,
			en: `Events in Bergenhus over the next two weeks — concerts at USF Verftet, exhibitions at Bryggens Museum, family activities at the Aquarium and more. From ${SOURCE_COUNT} local sources.`
		},
		editorial: {
			no: [
				...
				`Gåri viser alle arrangementer på Bergenhus de neste to ukene — konserter, utstillinger, teater, mat og familieaktiviteter. Listen hentes fra ${SOURCE_COUNT} lokale kilder og oppdateres daglig.`,
			...
			en: [
				...
				`Gåri shows all events in Bergenhus over the next two weeks — concerts, exhibitions, theatre, food and family activities. Listings are drawn from ${SOURCE_COUNT} local sources and updated daily.`,
		...
		faq: {
			no: [
				{ q: 'Hva skjer på Bergenhus?', a: `Gåri viser alle arrangementer på Bergenhus de neste to ukene — konserter, utstillinger, teater og familieaktiviteter fra ${SOURCE_COUNT} lokale kilder.` },
			...
			en: [
				{ q: 'What\'s on in Bergenhus?', a: `Gåri shows all events in Bergenhus over the next two weeks — concerts, exhibitions, theatre and family activities from ${SOURCE_COUNT} local sources.` },
	...
	},
	{
		...
		quickAnswer: {
			no: `Arrangementer i Laksevåg de neste to ukene — konserter på Bergen Kjøtt, kultur på Kulturhuset i Bergen og mer. Fra ${SOURCE_COUNT} lokale kilder.`,
			en: `Events in Laksevåg over the next two weeks — concerts at Bergen Kjøtt, culture at Kulturhuset i Bergen and more. From ${SOURCE_COUNT} local sources.`
		},
		editorial: {
			no: [
				...
				`Gåri viser alle arrangementer i Laksevåg de neste to ukene — konserter, utstillinger og kulturarrangementer. Listen hentes fra ${SOURCE_COUNT} lokale kilder og oppdateres daglig.`,
			...
			en: [
				...
				`Gåri shows all events in Laksevåg over the next two weeks — concerts, exhibitions and cultural events. Listings are drawn from ${SOURCE_COUNT} local sources and updated daily.`,
		...
		faq: {
			no: [
				{ q: 'Hva skjer i Laksevåg?', a: `Gåri viser alle arrangementer i Laksevåg de neste to ukene — konserter på Bergen Kjøtt, kultur på Kulturhuset og mer fra ${SOURCE_COUNT} lokale kilder.` },
			...
			en: [
				{ q: 'What\'s on in Laksevåg?', a: `Gåri shows all events in Laksevåg over the next two weeks — concerts at Bergen Kjøtt, culture at Kulturhuset and more from ${SOURCE_COUNT} local sources.` },
	...
	},
	{
		...
		quickAnswer: {
			no: `Arrangementer i Fyllingsdalen de neste to ukene — teater, familieforestillinger og kulturarrangementer. Fra ${SOURCE_COUNT} lokale kilder.`,
			en: `Events in Fyllingsdalen over the next two weeks — theatre, family shows and cultural events. From ${SOURCE_COUNT} local sources.`
		},
		editorial: {
			no: [
				...
				`Gåri viser alle arrangementer i Fyllingsdalen de neste to ukene. Listen hentes fra ${SOURCE_COUNT} lokale kilder og oppdateres daglig.`,
			...
			en: [
				...
				`Gåri shows all events in Fyllingsdalen over the next two weeks. Listings are drawn from ${SOURCE_COUNT} local sources and updated daily.`,
		...
		faq: {
			no: [
				{ q: 'Hva skjer i Fyllingsdalen?', a: `Gåri viser alle arrangementer i Fyllingsdalen de neste to ukene — teater, familieforestillinger og kulturarrangementer fra ${SOURCE_COUNT} lokale kilder.` },
			...
			en: [
				{ q: 'What\'s on in Fyllingsdalen?', a: `Gåri shows all events in Fyllingsdalen over the next two weeks — theatre, family shows and cultural events from ${SOURCE_COUNT} local sources.` },
	...
	},
	{
		...
		quickAnswer: {
			no: `Arrangementer i Åsane de neste to ukene — konserter, familieaktiviteter og kulturarrangementer. Fra ${SOURCE_COUNT} lokale kilder.`,
			en: `Events in Åsane over the next two weeks — concerts, family activities and cultural events. From ${SOURCE_COUNT} local sources.`
		},
		editorial: {
			no: [
				...
				`Gåri viser alle arrangementer i Åsane de neste to ukene. Listen hentes fra ${SOURCE_COUNT} lokale kilder og oppdateres daglig.`,
			...
			en: [
				...
				`Gåri shows all events in Åsane over the next two weeks. Listings are drawn from ${SOURCE_COUNT} local sources and updated daily.`,
		...
		faq: {
			no: [
				{ q: 'Hva skjer i Åsane?', a: `Gåri viser alle arrangementer i Åsane de neste to ukene — konserter, familieforestillinger og kulturarrangementer fra ${SOURCE_COUNT} lokale kilder.` },
			...
			en: [
				{ q: 'What\'s on in Åsane?', a: `Gåri shows all events in Åsane over the next two weeks — concerts, family shows and cultural events from ${SOURCE_COUNT} local sources.` },
	...
	},
	{
		...
		quickAnswer: {
			no: `Arrangementer i Fana de neste to ukene — konserter på Troldhaugen, utstillinger på Hordamuseet og kulturarrangementer. Fra ${SOURCE_COUNT} lokale kilder.`,
			en: `Events in Fana over the next two weeks — concerts at Troldhaugen, exhibitions at Hordamuseet and cultural events. From ${SOURCE_COUNT} local sources.`
		},
		editorial: {
			no: [
				...
				`Gåri viser alle arrangementer i Fana de neste to ukene. Listen hentes fra ${SOURCE_COUNT} lokale kilder og oppdateres daglig.`,
			...
			en: [
				...
				`Gåri shows all events in Fana over the next two weeks. Listings are drawn from ${SOURCE_COUNT} local sources and updated daily.`,
		...
		faq: {
			no: [
				{ q: 'Hva skjer i Fana?', a: `Gåri viser alle arrangementer i Fana de neste to ukene — konserter på Troldhaugen, utstillinger på Hordamuseet og mer fra ${SOURCE_COUNT} lokale kilder.` },
			...
			en: [
				{ q: 'What\'s on in Fana?', a: `Gåri shows all events in Fana over the next two weeks — concerts at Troldhaugen, exhibitions at Hordamuseet and more from ${SOURCE_COUNT} local sources.` },
	...
	},
	{
		...
		quickAnswer: {
			no: `Arrangementer i Ytrebygda de neste to ukene — kulturarrangementer og aktiviteter. Fra ${SOURCE_COUNT} lokale kilder.`,
			en: `Events in Ytrebygda over the next two weeks — cultural events and activities. From ${SOURCE_COUNT} local sources.`
		},
		editorial: {
			no: [
				...
				`Gåri viser alle arrangementer i Ytrebygda de neste to ukene. Listen hentes fra ${SOURCE_COUNT} lokale kilder og oppdateres daglig.`,
			...
			en: [
				...
				`Gåri shows all events in Ytrebygda over the next two weeks. Listings are drawn from ${SOURCE_COUNT} local sources and updated daily.`,
		...
		faq: {
			no: [
				{ q: 'Hva skjer i Ytrebygda?', a: `Gåri viser alle arrangementer i Ytrebygda de neste to ukene — kulturarrangementer og aktiviteter fra ${SOURCE_COUNT} lokale kilder.` },
			...
			en: [
				{ q: 'What\'s on in Ytrebygda?', a: `Gåri shows all events in Ytrebygda over the next two weeks — cultural events and activities from ${SOURCE_COUNT} local sources.` },
	...
	},
	{
		...
		quickAnswer: {
			no: `Arrangementer i Arna de neste to ukene — kulturarrangementer og aktiviteter. Fra ${SOURCE_COUNT} lokale kilder.`,
			en: `Events in Arna over the next two weeks — cultural events and activities. From ${SOURCE_COUNT} local sources.`
		},
		editorial: {
			no: [
				...
				`Gåri viser alle arrangementer i Arna de neste to ukene. Listen hentes fra ${SOURCE_COUNT} lokale kilder og oppdateres daglig.`,
			...
			en: [
				...
				`Gåri shows all events in Arna over the next two weeks. Listings are drawn from ${SOURCE_COUNT} local sources and updated daily.`,
		...
		faq: {
			no: [
				{ q: 'Hva skjer i Arna?', a: `Gåri viser alle arrangementer i Arna de neste to ukene — kulturarrangementer og aktiviteter fra ${SOURCE_COUNT} lokale kilder.` },
			...
			en: [
				{ q: 'What\'s on in Arna?', a: `Gåri shows all events in Arna over the next two weeks — cultural events and activities from ${SOURCE_COUNT} local sources.` },
	...
	},
	{
		...
		relatedSlugs: ['konserter', 'teater', 'utstillinger', 'mat-og-drikke'],
		...
		quickAnswer: {
			no: `Kulturopplevelser for voksne i Bergen de neste to ukene — konserter, teater, omvisninger, utstillinger og matarrangementer. Samlet fra ${SOURCE_COUNT} lokale kilder.`,
			en: `Cultural experiences for adults in Bergen over the next two weeks — concerts, theatre, guided tours, exhibitions and food events. Collected from ${SOURCE_COUNT} local sources.`
		},
		editorial: {
			no: [
				...
				`Gåri samler arrangementer innen musikk, kultur, teater, omvisninger, mat og verksteder — alt tilpasset voksne. Listen hentes fra over ${SOURCE_COUNT} lokale kilder og oppdateres daglig. Utsolgte arrangementer fjernes fortløpende.`,
			...
			en: [
				...
				`Gåri collects events in music, culture, theatre, guided tours, food and workshops — all suited to adults. Listings are drawn from over ${SOURCE_COUNT} local sources and updated daily. Sold-out events are removed as soon as they sell out.`,
		...
		faq: {
			no: [
				...
				{ q: 'Hva er de beste kulturopplevelsene for voksne i Bergen?', a: 'For voksne er Grieghallen, Den Nationale Scene og KODE toppen av Bergens kulturtilbud. Nattjazz i mai er Norges største jazzfestival. Festspillene i juni samler internasjonale artister. Litteraturhuset har foredrag og debatter hele året.' }
			],
			en: [
				...
				{ q: 'What are the best cultural experiences for adults visiting Bergen?', a: 'For adults, Grieghallen, Den Nationale Scene and KODE represent the best of Bergen\'s cultural scene. Nattjazz in May is Norway\'s largest jazz festival. Festspillene in June brings international artists. Litteraturhuset hosts talks and debates year-round.' }
			]
		},
		filterEvents: (events, now) => {
			const todayStr = toOsloDateStr(now);
	...
	},
	{
		...
		quickAnswer: {
			no: `Arrangementer for ungdom (13–18 år) i Bergen de neste to ukene — konserter, kultur, sport og workshops. Uten uteliv og 18+-arrangementer. Fra ${SOURCE_COUNT} lokale kilder.`,
			en: `Events for teens (13–18) in Bergen over the next two weeks — concerts, culture, sports and workshops. No nightlife or 18+ events. From ${SOURCE_COUNT} local sources.`
		},
		editorial: {
			no: [
				...
				`Gåri samler arrangementer fra over ${SOURCE_COUNT} lokale kilder og oppdaterer listen daglig. Vi filtrerer bort arrangementer med aldersgrense (18+/20+) og uteliv, slik at det som vises passer for aldersgruppen 13\u201318 år.`,
			...
			en: [
				...
				`Gåri collects events from over ${SOURCE_COUNT} local sources and updates the listing daily. We filter out events with age restrictions (18+/20+) and nightlife, so everything shown is suitable for the 13\u201318 age group.`,
		...
		faq: {
			no: [
				...
				{ q: 'Er Bergen trygt for ungdom på kvelden?', a: 'Bergen er en trygg by. Sentrum, Kvarteret-området og bibliotekene er trygge møtesteder. Kulturhuset i Bergen og ungdomshusene arrangerer jevnlig kveldsarrangementer tilrettelagt for tenåringer.' }
			],
			en: [
				...
				{ q: 'Is Bergen safe for teenagers in the evening?', a: 'Bergen is a safe city. The city centre, the Kvarteret area and the libraries are safe meeting points for young people. Kulturhuset i Bergen regularly organises evening events designed for teenagers.' }
			]
		},
		filterEvents: (events, now) => {
			const todayStr = toOsloDateStr(now);
...

	{
		...
		title: {
			no: 'Teater i Bergen',
			en: 'Theatre in Bergen'
		},
		description: {
			no: 'Teaterforestillinger i Bergen de neste to ukene — DNS, Det Vestnorske Teateret, BIT, Cornerteateret og Carte Blanche. Oppdatert daglig.',
			en: 'Theatre in Bergen over the next two weeks — DNS, Det Vestnorske Teateret, BIT, Cornerteateret and Carte Blanche. Updated daily.'
		},
		ogSubtitle: {
			no: 'Forestillinger de neste to ukene',
			en: 'Performances over the next two weeks'
		},
		relatedSlugs: ['konserter', 'denne-helgen', 'voksen', 'regndagsguide'],
		footerLabel: { no: 'Teater', en: 'Theatre' },
		footer: { langs: ['no', 'en'], order: 17 },
		newsletterHeading: { no: 'Teater­tips rett i innboksen', en: 'Theatre picks in your inbox' },
		quickAnswer: {
			no: `Alle teaterforestillinger i Bergen de neste to ukene — fra Den Nationale Scene og Det Vestnorske Teateret til Bergen Internasjonale Teater (BIT) og Cornerteateret. Samlet fra ${SOURCE_COUNT} lokale kilder.`,
			en: `All theatre performances in Bergen over the next two weeks — from Den Nationale Scene and Det Vestnorske Teateret to Bergen Internasjonale Teater (BIT) and Cornerteateret. Collected from ${SOURCE_COUNT} local sources.`
		},
		editorial: {
			no: [
				...
				`Gåri samler alle teaterforestillinger i Bergen de neste to ukene fra ${SOURCE_COUNT} lokale kilder — direkte fra teatrenes egne nettsider og billettsystemer. Listen oppdateres daglig, og utsolgte forestillinger fjernes automatisk.`,
			...
			en: [
				...
				`Gåri collects all theatre performances in Bergen over the next two weeks from ${SOURCE_COUNT} local sources — directly from the theatres' own websites and ticketing systems. The listing is updated daily and sold-out shows are removed automatically.`,
		...
		faq: {
			no: [
				{ q: 'Hvilke teaterforestillinger er det i Bergen?', a: `Gåri samler alle teaterforestillinger i Bergen de neste to ukene fra ${SOURCE_COUNT} lokale kilder. Oppdatert daglig.` },
				...
				{ q: 'Hva er det beste teateret i Bergen?', a: 'DNS er størst og har det bredeste repertoaret. Bergen Internasjonale Teater (BIT) er ledende på eksperimentelt teater. Det Vestnorske Teateret er kjent for nynorsk scenekunst.' },
			...
			en: [
				{ q: 'What theatre shows are on in Bergen?', a: `Gåri collects all theatre performances in Bergen over the next two weeks from ${SOURCE_COUNT} local sources. Updated daily.` },
				...
				{ q: 'What is the best theatre in Bergen?', a: 'DNS is the largest with the broadest repertoire. Bergen Internasjonale Teater (BIT) leads on experimental theatre. Det Vestnorske Teateret is known for Nynorsk performing arts.' },
				{ q: 'When is theatre season in Bergen?', a: 'Bergen\'s theatres run from September to June. The Bergen International Festival in May/June brings guest productions. Summer has fewer regular shows but occasional outdoor performances.' }
			]
		},
		filterEvents: (events, now) => {
			const todayStr = toOsloDateStr(now);
	...
	},
	{
		...
		slug: 'utstillinger',
		title: {
			no: 'Utstillinger i Bergen',
			en: 'Exhibitions in Bergen'
		},
		description: {
			no: 'Utstillinger i Bergen de neste to ukene — KODE, Bergen Kunsthall, Bymuseet og flere. Samtidskunst, kulturhistorie og omvisninger.',
			en: 'Exhibitions in Bergen over the next two weeks — KODE, Bergen Kunsthall, Bymuseet and more. Contemporary art, cultural history and guided tours.'
		},
		ogSubtitle: {
			no: 'Kunst og kultur de neste to ukene',
			en: 'Art and culture over the next two weeks'
		},
		relatedSlugs: ['regndagsguide', 'denne-helgen', 'voksen', 'gratis'],
		footerLabel: { no: 'Utstillinger', en: 'Exhibitions' },
		footer: { langs: ['no', 'en'], order: 18 },
		newsletterHeading: { no: 'Ukens utstillinger i Bergen', en: 'This week\'s exhibitions in Bergen' },
		quickAnswer: {
			no: `Alle utstillinger og kulturarrangementer i Bergen de neste to ukene — KODE, Bergen Kunsthall, Bymuseet og mer. Samlet fra ${SOURCE_COUNT} lokale kilder.`,
			en: `All exhibitions and cultural events in Bergen over the next two weeks — KODE, Bergen Kunsthall, Bymuseet and more. Collected from ${SOURCE_COUNT} local sources.`
		},
		editorial: {
			no: [
				...
				`Gåri samler alle utstillinger og kulturarrangementer i Bergen de neste to ukene fra ${SOURCE_COUNT} lokale kilder. Listen inkluderer åpningskvelder, omvisninger, foredrag og faste utstillinger med arrangementer.`,
			...
			en: [
				...
				`Gåri collects all exhibitions and cultural events in Bergen over the next two weeks from ${SOURCE_COUNT} local sources. The listing includes opening nights, guided tours, talks and permanent exhibitions with events.`,
		...
		faq: {
			no: [
				{ q: 'Hvilke utstillinger er det i Bergen?', a: 'Gåri viser alle utstillinger og kulturarrangementer i Bergen de neste to ukene — KODE, Bergen Kunsthall, Bymuseet og flere. Oppdatert daglig.' },
				{ q: 'Er det gratis utstillinger i Bergen?', a: 'Bergen Kunsthall har gratis inngangsdager. Flere museer har gratis inngang for barn og ungdom. Sjekk Gåris gratis-side for oversikt.' },
				{ q: 'Hva er KODE i Bergen?', a: 'KODE er Norges største kunstmuseum med fire bygg i Bergen sentrum. Samlingen inkluderer Edvard Grieg, Nikolai Astrup og internasjonal samtidskunst.' },
				{ q: 'Hvilke museer har Bergen?', a: 'KODE (4 bygg), Bergen Kunsthall, Bymuseet (Bryggens Museum, Håkonshallen m.fl.), Museum Vest, Akvariet og VilVite vitensenteret.' },
				{ q: 'Er Bergen et godt reisemål for kunst?', a: 'Ja — KODE er et av Nordens største kunstmuseer. Bergen Kunsthall er anerkjent for samtidskunst. Borealis-festivalen og Festspillene bringer internasjonale utstillinger til byen.' },
				{ q: 'Hvilke utstillinger åpner i Bergen denne uken?', a: 'Gåri oppdaterer listen over utstillinger daglig. Nye åpninger og vernissager vises med dato og sted. Sjekk utstillingssiden for de neste to ukene.' },
				{ q: 'Er det omvisninger på museene i Bergen?', a: 'KODE, Bymuseet og Bergen Kunsthall tilbyr jevnlige omvisninger. Gåri viser kommende omvisninger med tidspunkt og pris.' }
			],
			en: [
				{ q: 'What exhibitions are on in Bergen?', a: 'Gåri shows all exhibitions and cultural events in Bergen over the next two weeks — KODE, Bergen Kunsthall, Bymuseet and more. Updated daily.' },
				{ q: 'Are there free exhibitions in Bergen?', a: 'Bergen Kunsthall has free entry days. Several museums offer free entry for children and young people. Check Gåri\'s free events page for listings.' },
				{ q: 'What is KODE in Bergen?', a: 'KODE is Norway\'s largest art museum with four buildings in Bergen city centre. The collection includes Edvard Grieg, Nikolai Astrup and international contemporary art.' },
				{ q: 'What museums does Bergen have?', a: 'KODE (4 buildings), Bergen Kunsthall, Bymuseet (Bryggens Museum, Håkonshallen and more), Museum Vest, the Aquarium and VilVite science centre.' },
				{ q: 'Is Bergen a good destination for art?', a: 'Yes — KODE is one of the Nordic region\'s largest art museums. Bergen Kunsthall is recognised for contemporary art. The Borealis festival and Bergen International Festival bring international exhibitions.' },
				{ q: 'What exhibitions are opening in Bergen this week?', a: 'Gåri updates the exhibition listing daily. New openings and vernissages are shown with date and venue. Check the exhibitions page for the next two weeks.' },
				{ q: 'Are there guided tours at Bergen museums?', a: 'KODE, Bymuseet and Bergen Kunsthall offer regular guided tours. Gåri lists upcoming tours with times and prices.' }
			]
		},
		filterEvents: (events, now) => {
			const todayStr = toOsloDateStr(now);
	...
	},
	{
		...
		slug: 'mat-og-drikke',
		title: {
			no: 'Mat og drikke i Bergen',
			en: 'Food & Drink Events in Bergen'
		},
		description: {
			no: 'Mat og drikke i Bergen de neste to ukene — kokekurs, smakinger, matmarkeder og kulinariske arrangementer. Oppdatert daglig.',
			en: 'Food and drink events in Bergen over the next two weeks — cooking classes, tastings, food markets and culinary events. Updated daily.'
		},
		ogSubtitle: {
			no: 'Kulinariske opplevelser',
			en: 'Culinary experiences'
		},
		relatedSlugs: ['denne-helgen', 'gratis', 'voksen', 'sentrum'],
		footerLabel: { no: 'Mat og drikke', en: 'Food & drink' },
		footer: { langs: ['no', 'en'], order: 19 },
		newsletterHeading: { no: 'Mat­tips i Bergen denne uken', en: 'Food event picks in Bergen' },
		quickAnswer: {
			no: `Matopplevelser i Bergen de neste to ukene — kurs, smakinger, matmarkeder og kulinariske arrangementer. Samlet fra ${SOURCE_COUNT} lokale kilder.`,
			en: `Food experiences in Bergen over the next two weeks — cooking classes, tastings, food markets and culinary events. Collected from ${SOURCE_COUNT} local sources.`
		},
		editorial: {
			no: [
				...
				`Gåri samler alle matarrangementer i Bergen de neste to ukene fra ${SOURCE_COUNT} lokale kilder — restauranter, matprodusenter, kulturhus og arrangører. Listen inkluderer kokekurs, smakinger, matmarkeder og kulinariske festivaler.`,
			...
			en: [
				...
				`Gåri collects all food events in Bergen over the next two weeks from ${SOURCE_COUNT} local sources — restaurants, food producers, cultural venues and organisers. The listing includes cooking classes, tastings, food markets and culinary festivals.`,
		...
		faq: {
			no: [
				{ q: 'Hva skjer innen mat i Bergen?', a: `Gåri viser alle matarrangementer i Bergen de neste to ukene — kokekurs, smakinger, matmarkeder og kulinariske opplevelser fra ${SOURCE_COUNT} lokale kilder.` },
				...
				{ q: 'Hva er de beste matarrangementene i Bergen denne uken?', a: 'Gåri oppdaterer listen over matarrangementer daglig. Kokekurs, smakinger og matmarkeder vises med dato og pris. Sjekk mat og drikke-siden for de neste to ukene.' },
				{ q: 'Er det vinsmaking i Bergen?', a: 'Bergen har jevnlige vinsmaking-arrangementer på restauranter og kulturhus. Colonialen og flere spesialistbutikker holder smakinger. Sjekk Gåri for kommende smakinger med dato og pris.' }
			],
			en: [
				{ q: 'What food events are on in Bergen?', a: `Gåri shows all food events in Bergen over the next two weeks — cooking classes, tastings, food markets and culinary experiences from ${SOURCE_COUNT} local sources.` },
				...
				{ q: 'Are there free food experiences in Bergen?', a: 'The Fish Market is free to visit. Seasonal markets often have free tastings. Check Gåri\'s free events page for no-cost food events.' },
				{ q: 'What are the best food events in Bergen this week?', a: 'Gåri updates the food event listing daily. Cooking classes, tastings and food markets are shown with date and price. Check the food and drink page for the next two weeks.' },
				{ q: 'Are there wine tastings in Bergen?', a: 'Bergen has regular wine tasting events at restaurants and cultural venues. Colonialen and specialist shops hold tastings. Check Gåri for upcoming tastings with dates and prices.' }
			]
		},
		filterEvents: (events, now) => {
			const todayStr = toOsloDateStr(now);
...

	{
		...
		description: {
			no: `17. mai-program i Bergen: barnetog, buekorps, konserter og arrangementer. Oppdatert oversikt fra ${SOURCE_COUNT} lokale kilder.`,
			en: `Complete 17th of May programme for Bergen: children's parades, buekorps brigades, concerts and events. Updated daily from ${SOURCE_COUNT} local sources.`
		},
		ogSubtitle: {
		...
		quickAnswer: {
			no: `Bergen feirer 17. mai med barnetog gjennom sentrum, buekorps-marsjer — en tradisjon unik for Bergen — konserter på Torgallmenningen og Festplassen, og familieaktiviteter over hele byen. Gåri samler alle arrangementer fra ${SOURCE_COUNT} lokale kilder.`,
		...
		editorial: {
			no: [
				...
				`Gåri samler 17. mai-arrangementer fra over ${SOURCE_COUNT} lokale kilder — spillesteder, kulturinstitusjoner, festivalarrangører og billettplattformer. Denne siden oppdateres daglig når programmet nærmer seg. Se også familiehelg-siden for barnevennlige aktiviteter.`
			],
			en: [
				...
				`Gåri collects 17th of May events from over ${SOURCE_COUNT} local sources — venues, cultural institutions, festival organisers and ticketing platforms. This page is updated daily as the programme approaches. See the family weekend page for child-friendly activities year-round.`
			]
		},
		faq: {
			no: [
				{ q: 'Hva skjer 17. mai i Bergen?', a: `Bergen feirer 17. mai med barnetog, buekorps-marsjer, konserter på Torgallmenningen og Festplassen, og aktiviteter over hele byen. Gåri viser alle arrangementer fra ${SOURCE_COUNT} lokale kilder.` },
				...
				{ q: 'Hvor ser man 17. mai-toget i Bergen?', a: 'Barnetoget går fra Festplassen gjennom Torgallmenningen og sentrum. Langs Strandgaten og Torgallmenningen er det best utsikt. Kom tidlig for å sikre en god plass.' },
				{ q: 'Er det konserter 17. mai i Bergen?', a: 'Bergen har konserter på Festplassen, Torgallmenningen og på spillesteder som Grieghallen og Ole Bull. Mange er gratis. Gåri samler alle 17. mai-konserter.' }
			],
			en: [
				{ q: "What happens on 17th of May in Bergen?", a: `Bergen celebrates Constitution Day with children's parades, buekorps marching brigades, concerts at Torgallmenningen and Festplassen, and activities across the city. Gåri lists all events from ${SOURCE_COUNT} local sources.` },
				...
				{ q: 'Where is the best place to watch the 17th of May parade in Bergen?', a: "The children's parade goes from Festplassen through Torgallmenningen and the city centre. Along Strandgaten and Torgallmenningen offers the best views. Arrive early for a good spot." },
				{ q: 'Are there concerts on 17th of May in Bergen?', a: 'Bergen has concerts at Festplassen, Torgallmenningen and venues like Grieghallen and Ole Bull. Many are free. Gåri lists all 17th of May concerts.' }
			]
		},
		offSeasonHint: {
	...
	},
	{
		...
		description: {
			no: `Julemarkeder, konserter, Pepperkakebyen og juleaktiviteter i Bergen. Komplett oversikt over julesesongen fra ${SOURCE_COUNT} lokale kilder.`,
			en: `Christmas markets, concerts, the Gingerbread City and holiday events in Bergen. Complete guide to the Christmas season from ${SOURCE_COUNT} sources.`
		},
		ogSubtitle: {
	...
	},
	{
		...
		description: {
			...
			en: `Midsummer in Bergen: bonfires, parties, concerts and events around June 23. Complete guide from ${SOURCE_COUNT} local sources.`
		},
		ogSubtitle: {
...

	{
		...
		editorial: {
			no: [
				...
				`Gåri samler 17. mai-arrangementer fra over ${SOURCE_COUNT} lokale kilder. Oppdatert daglig.`
			],
			en: [
				...
				`Gåri collects all 17th of May events from over ${SOURCE_COUNT} local sources — concerts, family activities and cultural events. Most celebrations are free and open to everyone. This page is updated daily as the programme approaches.`
			]
		},
		faq: {
			no: [
				{ q: 'Hva skjer 17. mai i Bergen?', a: `Barnetog, buekorps, konserter og feiringer over hele byen. Gåri viser alt fra ${SOURCE_COUNT} kilder.` },
	...
	},
	{
		...
		faq: {
			no: [
				{ q: 'Hva skjer i Bergen i påsken?', a: `Konserter, utstillinger, familieaktiviteter og gudstjenester. Gåri samler alt fra over ${SOURCE_COUNT} kilder.` },
...
/** Lightweight slug+label pairs for admin dropdowns. */
export function getCollectionOptions(): Array<{ slug: string; label: string }> {
	return collections.map(c => ({ slug: c.slug, label: c.title.no }));
}
