...
- **Social Posts** (`social-posts.yml`): cron daily 07:00 UTC (08:00 CET / 09:00 CEST), 5min timeout. Runs `scripts/social/generate-posts.ts` (carousel images + captions for 11 collections). Bluesky posting step disabled (Mar 2026). Secrets: SUPABASE keys.
