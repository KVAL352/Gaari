...
- **B2B page**: `/[lang]/for-arrangorer/` marketing page for venues. Voice: "Gåri/vi" (never "jeg/meg"). Features: animated AI chat phone mockup, venue lookup with inline add-form, product/report mockups, 54% SSB stat with source links, 3 CTAs + sticky mobile bar, Plausible tracking. Contact form inserts into `organizer_inquiries`. Sections 8+9 merged (early bird + CTA). No pricing shown — drives inquiry.
